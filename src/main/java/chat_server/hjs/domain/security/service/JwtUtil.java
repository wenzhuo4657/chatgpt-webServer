...
public class JwtUtil {
    ...
    private static JwtUtil DefaultJwtUtil;
    static {
        DefaultJwtUtil = new  JwtUtil(defaultBase64EncodedSecretKey, defaultSignatureAlgorithm);
    }

    public static JwtUtil DefaultJwtUtil() {
